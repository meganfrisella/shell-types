...
noncomputable def sort (input : stream_of_strings) : option stream_of_strings := 
  some { records := make_sort input.records,
...
-- no requirements on input
noncomputable def sort_r (input : stream_of_strings) : option stream_of_strings := 
  some { records := make_sort_r input.records,
    column_types := input.column_types,
    per_line := input.per_line,
...
noncomputable def uniq (input : stream_of_strings) : option stream_of_strings := 
  some { records := make_uniq input.records,
    column_types := input.column_types,
    per_line := input.per_line,
...
-- a count column
noncomputable def uniq_c (input : stream_of_strings) : option stream_of_strings := 
  some { records := make_uniq_c input.records,
